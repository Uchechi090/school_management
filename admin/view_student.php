...
<html xmlns="http://wwww.w3.org/1999/xhtml">
  <head>
   ...
   <title>SMS | View Student Details</title>
  ...
  <div id="container">
    ...
    <div id="side2">
      ...
      <div id="body">
       ...
       <?php echo '<p>'.$result['matric_no'].'<p></br>' ?>
       <?php echo '<p>'.$result['gender'].'<p></br>' ?>
       <?php echo '<p>'.$result['date_of_birth'].'<p></br>' ?>
       <?php echo '<p>'.$result['address'].'<p></br>' ?>
       <?php echo '<p>'.$result['nationality'].'<p></br>' ?>
       <?php echo '<p>'.$result['state_of_origin'].'<p></br>' ?>
       <?php echo '<p>'.$result['faculty'].'<p></br>' ?>
       <?php echo '<p>'.$result['department'].'<p></br>' ?>
       <?php echo '<p>'.$result['level'].'<p></br>' ?>

...
<html xmlns="http://wwww.w3.org/1999/xhtml">
  <head>
    ...
    <title>SMS | Add New Teachers</title>
  ...
  <?php
       ...
       if(array_key_exists('add', $_POST))   {
           ...
           if(empty($error))  {
                ...
                header("location:add_teacher.php?success=$msg");
    ...
    <div id="side2">
      ...
      <div id="body">
        <form action=""  method="POST">
            ...
            <fieldset><p>Date Of Birth</p></fieldset>

            <fieldset><input type="date"  name="date_of_birth"  placeholder="Date of Birth"/></fieldset>

            <fieldset><textarea  rows="5"  cols="20"  name="address"  
            ...
            <fieldset><textarea  rows="5"  cols="20"  name="hobbies"  placeholder="Hobbies"></textarea></fieldset>

            <fieldset><input type="password"  name="password"  placeholder="Password"/></fieldset>

            <fieldset><button type="submit"  name="add">Add Teacher</button></fieldset>
   </form>
      </div>
    </div>
  </div>
